...
public class StreamsExample {
    ...
    /**
     * [Employee[person=Person[firstName=John,lastName=Galt,age=20],jobHistory=[JobHistoryEntry[duration=3,position=dev,employer=epam], JobHistoryEntry[duration=2,position=dev,employer=google]]],
     * Employee[person=Person[firstName=John,lastName=Doe,age=21],jobHistory=[JobHistoryEntry[duration=4,position=BA,employer=yandex], JobHistoryEntry[duration=2,position=QA,employer=epam], JobHistoryEntry[duration=2,position=dev,employer=abc]]],
     * Employee[person=Person[firstName=John,lastName=White,age=22],jobHistory=[JobHistoryEntry[duration=6,position=QA,employer=epam]]],
     * Employee[person=Person[firstName=John,lastName=Galt,age=23],jobHistory=[JobHistoryEntry[duration=3,position=dev,employer=epam], JobHistoryEntry[duration=2,position=dev,employer=google]]],
     * Employee[person=Person[firstName=John,lastName=Doe,age=24],jobHistory=[JobHistoryEntry[duration=4,position=QA,employer=yandex], JobHistoryEntry[duration=2,position=BA,employer=epam], JobHistoryEntry[duration=2,position=dev,employer=abc]]],
     * Employee[person=Person[firstName=John,lastName=White,age=25],jobHistory=[JobHistoryEntry[duration=6,position=QA,employer=epam]]],
     * Employee[person=Person[firstName=John,lastName=Galt,age=26],jobHistory=[JobHistoryEntry[duration=3,position=dev,employer=epam], JobHistoryEntry[duration=1,position=dev,employer=google]]],
     * Employee[person=Person[firstName=Bob,lastName=Doe,age=27],jobHistory=[JobHistoryEntry[duration=4,position=QA,employer=yandex], JobHistoryEntry[duration=2,position=QA,employer=epam], JobHistoryEntry[duration=2,position=dev,employer=abc]]],
     * Employee[person=Person[firstName=John,lastName=White,age=28],jobHistory=[JobHistoryEntry[duration=6,position=BA,employer=epam]]],
     * Employee[person=Person[firstName=John,lastName=Galt,age=29],jobHistory=[JobHistoryEntry[duration=3,position=dev,employer=epam], JobHistoryEntry[duration=1,position=dev,employer=google]]],
     * Employee[person=Person[firstName=John,lastName=Doe,age=30],jobHistory=[JobHistoryEntry[duration=4,position=QA,employer=yandex], JobHistoryEntry[duration=2,position=QA,employer=epam], JobHistoryEntry[duration=5,position=dev,employer=abc]]],
     * Employee[person=Person[firstName=Bob,lastName=White,age=31],jobHistory=[JobHistoryEntry[duration=6,position=QA,employer=epam]]]]
     * @return
     */
    ...
    /**
     * JobHistoryEntry[duration=3,position=dev,employer=epam]
     * JobHistoryEntry[duration=2,position=dev,employer=google]
     * JobHistoryEntry[duration=4,position=BA,employer=yandex]
     * JobHistoryEntry[duration=2,position=QA,employer=epam]
     * JobHistoryEntry[duration=2,position=dev,employer=abc]
     * JobHistoryEntry[duration=6,position=QA,employer=epam]
     * JobHistoryEntry[duration=3,position=dev,employer=epam]
     * JobHistoryEntry[duration=2,position=dev,employer=google]
     * JobHistoryEntry[duration=4,position=QA,employer=yandex]
     * JobHistoryEntry[duration=2,position=BA,employer=epam]
     * JobHistoryEntry[duration=2,position=dev,employer=abc]
     * JobHistoryEntry[duration=6,position=QA,employer=epam]
     * JobHistoryEntry[duration=3,position=dev,employer=epam]
     * JobHistoryEntry[duration=1,position=dev,employer=google]
     * JobHistoryEntry[duration=6,position=BA,employer=epam]
     * JobHistoryEntry[duration=3,position=dev,employer=epam]
     * JobHistoryEntry[duration=1,position=dev,employer=google]
     * JobHistoryEntry[duration=4,position=QA,employer=yandex]
     * JobHistoryEntry[duration=2,position=QA,employer=epam]
     * JobHistoryEntry[duration=5,position=dev,employer=abc]
     *
     * Optional[JobHistoryEntry[duration=2,position=dev,employer=google]]
     */
    @Test
