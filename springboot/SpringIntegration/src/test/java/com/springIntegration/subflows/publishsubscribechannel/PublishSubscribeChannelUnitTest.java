package com.springIntegration.subflows.publishsubscribechannel;

import static org.junit.Assert.assertEquals;

import java.util.Arrays;

import com.tonels.springIntegration.subflows.publishsubscribechannel.PublishSubscibeChannelExample;
...
public class PublishSubscribeChannelUnitTest {
    ...
    @Autowired
    private PublishSubscibeChannelExample.NumbersClassifier numbersClassifier;
