...
import tonels.json.test.bean.*;
import tonels.json.test.bean.report.CaseReport;
import tonels.json.test.bean.report.StepReport;
import tonels.json.test.bean.report.SuiteReport;
