...
//        assertEquals(As.PROPERTY, v1.getInclusionType());
//        // default from annotation definition
...
//        assertEquals(As.EXTERNAL_PROPERTY, v2.getInclusionType());
...
//
//        assertEquals(As.PROPERTY, v.getInclusionType());
//        assertSame(v, v.withInclusionType(As.PROPERTY));
//        v2 = v.withInclusionType(As.EXTERNAL_PROPERTY);
//        assertEquals(As.EXTERNAL_PROPERTY, v2.getInclusionType());
//
