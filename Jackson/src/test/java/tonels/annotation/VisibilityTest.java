...
//
//        assertTrue(Visibility.ANY.isVisible(m));
//        assertFalse(Visibility.NONE.isVisible(m));
//
//        assertTrue(Visibility.NON_PRIVATE.isVisible(m));
//        assertTrue(Visibility.PUBLIC_ONLY.isVisible(m));
//        assertTrue(Visibility.PROTECTED_AND_PUBLIC.isVisible(m));
//        assertTrue(Visibility.NON_PRIVATE.isVisible(m));
//
//        // forget why DEFAULT would give false but
//        assertFalse(Visibility.DEFAULT.isVisible(m));
//    }
//
